...
| Nome        | Tipo           | Chiave  | Tipo di informazione  | Intervallo| Tag | Preprocesso|
| ------------- |:-------------|:-------------|:-------------|:-----|:-----|:-----|
|Stato del servizio "ekrn" (ESET Service)|Agente Zabbix| ``` service.info["ekrn",state] ``` |Numerico|1m|`Antivirus:ESET` `ESET:Componenti`|
|Stato del servizio "ekrnEpfw" (ESET Firewall Helper)|Agente Zabbix| ``` service.info["ekrnEpfw",state] ``` |Numerico|1m|`Antivirus:ESET` `ESET:Componenti`|
|Stato del servizio "EraAgentSvc" (ESET Management Agent)|Agente Zabbix| ``` service.info["EraAgentSvc",state] ``` |Numerico|1m|`Antivirus:ESET` `ESET:Componenti`|
